...
class TestInpFunctions(BaseTest):
    ...
    @pytest.fixture
    def gcmc_system(self,methane_oplsaa,fixed_lattice_compound,
                                            fixed_lattice_trappe):
    ...
    def test_vdw_style(self,twocomp_system,twobox_system):
        ...
        assert '# VDW_Style\nlj cut_switch 12.0 15.0\nlj cut_switch 11.0 13.0' in inp_data
    ...
    def test_mixing_rule(self,onecomp_system):
        ...
        with pytest.raises(ValueError,match=r'Custom mixing rule requested but'):
            inp_data = generate_input(system,moves,300.,
                                  'equilibration',500,
                                  mixing_rule='custom')
    ...
    def test_temperature(self,onecomp_system,twobox_system):
        (system, moves) = onecomp_system
        inp_data = generate_input(system,moves,200.0,
                                  'equilibration',500)
        ...
        with pytest.raises(TypeError,match=r'of type float'):
            inp_data = generate_input(system,moves,'string',
                                  'equilibration',500)
    ...
    def test_start_type(self,onecomp_system,
                             twocomp_system,
                             twobox_system,
